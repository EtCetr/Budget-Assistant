...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String message,  StackTrace? stackTrace)?  network,TResult Function( String message,  StackTrace? stackTrace)?  server,TResult Function( String message,  StackTrace? stackTrace)?  authentication,TResult Function( String message,  StackTrace? stackTrace)?  authorization,TResult Function( String message,  StackTrace? stackTrace)?  validation,TResult Function( String message,  StackTrace? stackTrace)?  database,TResult Function( String message,  StackTrace? stackTrace)?  encryption,TResult Function( String message,  StackTrace? stackTrace)?  biometric,TResult Function( String message,  StackTrace? stackTrace)?  pin,TResult Function( String message,  StackTrace? stackTrace)?  unexpected,required TResult orElse(),}) {final _that = this;
switch (_that) {
case NetworkFailure() when network != null:
return network(_that.message,_that.stackTrace);case ServerFailure() when server != null:
return server(_that.message,_that.stackTrace);case AuthenticationFailure() when authentication != null:
return authentication(_that.message,_that.stackTrace);case AuthorizationFailure() when authorization != null:
return authorization(_that.message,_that.stackTrace);case ValidationFailure() when validation != null:
return validation(_that.message,_that.stackTrace);case DatabaseFailure() when database != null:
return database(_that.message,_that.stackTrace);case EncryptionFailure() when encryption != null:
return encryption(_that.message,_that.stackTrace);case BiometricFailure() when biometric != null:
return biometric(_that.message,_that.stackTrace);case PinFailure() when pin != null:
return pin(_that.message,_that.stackTrace);case UnexpectedFailure() when unexpected != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String message,  StackTrace? stackTrace)  network,required TResult Function( String message,  StackTrace? stackTrace)  server,required TResult Function( String message,  StackTrace? stackTrace)  authentication,required TResult Function( String message,  StackTrace? stackTrace)  authorization,required TResult Function( String message,  StackTrace? stackTrace)  validation,required TResult Function( String message,  StackTrace? stackTrace)  database,required TResult Function( String message,  StackTrace? stackTrace)  encryption,required TResult Function( String message,  StackTrace? stackTrace)  biometric,required TResult Function( String message,  StackTrace? stackTrace)  pin,required TResult Function( String message,  StackTrace? stackTrace)  unexpected,}) {final _that = this;
switch (_that) {
case NetworkFailure():
return network(_that.message,_that.stackTrace);case ServerFailure():
return server(_that.message,_that.stackTrace);case AuthenticationFailure():
return authentication(_that.message,_that.stackTrace);case AuthorizationFailure():
return authorization(_that.message,_that.stackTrace);case ValidationFailure():
return validation(_that.message,_that.stackTrace);case DatabaseFailure():
return database(_that.message,_that.stackTrace);case EncryptionFailure():
return encryption(_that.message,_that.stackTrace);case BiometricFailure():
return biometric(_that.message,_that.stackTrace);case PinFailure():
return pin(_that.message,_that.stackTrace);case UnexpectedFailure():
return unexpected(_that.message,_that.stackTrace);case _:
  throw StateError('Unexpected subclass');
