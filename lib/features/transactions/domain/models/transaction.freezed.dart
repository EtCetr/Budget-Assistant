...
mixin _$Transaction {
 ...
 int? get originalAmount; TransactionType get type; String? get bankCategory; String? get customCategoryId; String? get merchantName; String? get comment; bool get isUserEdited; AuditStatus get auditStatus; bool get isHiddenByCalendar; DateTime? get hiddenUntilDate; int? get syncLockedStartedAt; int? get syncLockedDurationMs; bool get isArchivedForSpace; bool get businessMirror; String? get savingsGoalId; bool get isWithdrawal; bool get isSplit;/// Флаг крупной траты. Используется в аналитике
/// (P&L / Dashboard / Monthly Analytics) через фильтр excludeLargeExpenses.
 bool get isLargeExpense; String? get receiptId; DateTime get createdAt; DateTime get updatedAt; SyncStatus get syncStatus;
