...
class DashboardDataRepositoryImpl {
  ...
  Future<List<ExpenseFlowPoint>> getExpenseFlow({
    ...
    try {
      ...
      final startLocal = today.subtract(const Duration(days: 6));
      final startUtc = startLocal.toUtc();
      final endUtc = DateTime(now.year, now.month, now.day, 23, 59, 59, 999).toUtc();
      ...
      final largeClause = excludeLargeExpenses ? 'AND is_large_expense = 0' : '';
...
''',
      ...
      _logger.e('DashboardDataRepository.getExpenseFlow failed', error: e, stackTrace: st);
      rethrow;
    }
  }
...
''',
      ...
      _logger.e('DashboardDataRepository.getActiveCashback failed', error: e, stackTrace: st);
      rethrow;
    }
  }
